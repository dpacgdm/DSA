<!-- ANSWER KEYS MOVED: see Retention Questions/keys/Week 2 Drilling Set.keys.md -->
> **Blind mode:** Approach/Solution blocks moved to `keys/Week 2 Drilling Set.keys.md`.
...
> **Approach/Solution →** `keys/Week 2 Drilling Set.keys.md` (### Problem 12: The Boss — Alien Dictionary)
